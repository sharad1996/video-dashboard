...
function Alerts() {
	...
	const [addAlertPopup, setAddAlertPopup] = React.useState(false);
	...
	// 	setAddAlertPopup(!addAlertPopup);
	// };
	...
	return (
		<div className = 'dashboard-container'>
			...
			<div className = 'alerts-header mb-3'>
				...
				<Link to="/add-alert"><Button className='add-alert'><b>+ Add new alert</b></Button></Link>
			</div>
